...
|---|---|---|
| `slimbus-audio-context.md` | the SLIMbus/WCD9335 audio investigation, `folyt.` entries through the framer wall coming down | [`docs/audio/bringup/`](https://github.com/llg179org/fp3-pmaports/tree/main/docs/audio/bringup) for the story, [`docs/audio/`](https://github.com/llg179org/fp3-pmaports/tree/main/docs/audio) for how audio works today |
