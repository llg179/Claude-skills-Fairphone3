#!/usr/bin/env python3
# HWL1 (v3) reader: minimal single-record HalHwIo CGC-enable leaf trace.
import mmap, struct
...
magic=buf[HDR:HDR+4]
print("magic :", magic, "->", "HWL1 OK" if magic==b"HWL1" else "ABSENT (leaf never wrote / cave didn't run)")
if magic!=b"HWL1": raise SystemExit
