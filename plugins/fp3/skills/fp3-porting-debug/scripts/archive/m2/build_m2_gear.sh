...
cd "$(dirname "$0")"
STOCK=adsp.mbn
CAVE_S=m2_gear_cave.s ; CAVE_VA=0xf064e098
SITE_S=m2_gear_site.s ; SITE_VA=0xf04bfaa0
SITE_ORIG="10 40 60 70 10 1c f4 eb"
OUT_UNS=adsp-m2gear.mbn
OUT_SIG=adsp-m2gear-signed.mbn
MC=""; OC=""
