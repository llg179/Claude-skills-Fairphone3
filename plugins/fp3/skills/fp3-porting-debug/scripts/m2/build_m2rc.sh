...
OUT_UNS=adsp-m2rc.mbn ; OUT_SIG=adsp-m2rc-signed.mbn
MC=""; OC=""
...
asm "$CAVE_S" rccave.bin ; echo "cave: $(wc -c < rccave.bin) bytes"
...
# (2) cave
cave=open("rccave.bin","rb").read(); co=v2o(cave_va); region=bytes(buf[co:co+len(cave)])
