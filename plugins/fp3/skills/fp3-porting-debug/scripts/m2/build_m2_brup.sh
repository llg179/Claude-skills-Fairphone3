...
cd "$(dirname "$0")"
STOCK=adsp.mbn
CAVE_S=m2_brup_cave.s ; CAVE_VA=0xf064e098 ; CAVE_VA=0xf064e098
SITE_S=m2_brup_site.s ; SITE_VA=0xf04c36e0
SITE_ORIG="4a 78 6a 5b 02 c0 9d a0"
OUT_UNS=adsp-m2brup.mbn
OUT_SIG=adsp-m2brup-signed.mbn
MC=""; OC=""
