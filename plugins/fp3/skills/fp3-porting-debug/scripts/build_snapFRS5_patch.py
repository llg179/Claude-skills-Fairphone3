...
OUT=f"{FP3_ROOT}/adsp-snapFRS5.mbn"
DELTA=0xf00fd000
def foff(va): return va-DELTA
SPLICE_VA=0xf04c36e8; STOCK=0x7060c010     # { r16 = r0 } single-word (mode-update entry, FMD2-proven on dead)
CAVE_VA=0xf064e098
RET_VA=0xf04c36ec
FRAMER=0xee140000
...
a=os.path.join(here,"snapFRS5.s");o=os.path.join(here,"snapFRS5.o");b=os.path.join(here,"snapFRS5.bin")
open(a,"w").write(ASM)
